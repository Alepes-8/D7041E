...
sentences = []
file = open("lab5\Lab4\GensimW2V\lemmatized.text", "r")
...
dimension = 100 # parameter for Word2vec size of vectors for word embedding

threshold = 0.00055 # parameter for Word2vec lab5\Lab4\GensimW2V\main.py
...
for n in range(5):
    ...
    number_of_tests = 80
    text_file = open('lab5/Lab4/GensimW2V/new_toefl.txt', 'r')
